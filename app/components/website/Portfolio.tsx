...
import { ArrowRight, TrendingUp, Users, DollarSign, Star, ImageIcon, ExternalLink } from "lucide-react"
...
export default function Portfolio() {
  ...
  const caseStudies = [
    {
      ...
      challenge: "Low conversion rates, poor product visibility, and declining market share on Amazon",
      solution: "Complete listing optimization, advanced PPC management, and brand store redesign",
      results: {
        salesIncrease: "285%",
        conversionRate: "18.5%",
        roiImprovement: "340%",
      ...
      services: ["Listing Optimization", "PPC Management", "Brand Store Design"],
      imageAlt: "Fashion e-commerce transformation analytics dashboard showing growth metrics",
    },
    {
      title: "Electronics Marketplace Domination",
      client: "TechGear Pro",
      industry: "Electronics & Technology",
      challenge: "High competition, complex inventory management, and declining profit margins",
      solution: "Multi-platform strategy with advanced automation, predictive analytics, and smart pricing",
      results: {
        salesIncrease: "420%",
        conversionRate: "22.8%",
        roiImprovement: "550%",
      ...
      services: ["Multi-Platform Management", "Process Automation", "Predictive Analytics"],
      imageAlt: "Electronics marketplace performance dashboard with real-time analytics",
    },
    {
      title: "Home & Garden Success Revolution",
      client: "Garden Paradise",
      industry: "Home & Garden",
      challenge: "Seasonal sales fluctuations, inventory waste, and poor customer retention",
      solution: "Seasonal optimization strategy with smart inventory management and customer lifecycle automation",
      results: {
        salesIncrease: "190%",
        conversionRate: "16.8%",
        roiImprovement: "280%",
      ...
      services: ["Seasonal Optimization", "Smart Inventory Management", "Customer Lifecycle Automation"],
      imageAlt: "Home and garden seasonal optimization dashboard with predictive insights",
    },
  ]
  ...
  const metrics = [
    ...
    { label: "Clients Transformed", value: "500+", icon: <Users className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400" /> },
    {
      label: "Revenue Generated",
      value: "$75M+",
      icon: <DollarSign className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400" />,
    },
    { label: "Client Satisfaction", value: "98%", icon: <Star className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400" /> },
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed px-4">
              Discover how we've helped businesses like yours achieve remarkable growth and success with our proven
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Real results that speak for themselves and demonstrate our commitment to excellence
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-10">
            {metrics.map((metric, index) => (
              ...
              >
                ...
                <div className="text-gray-600 font-semibold text-sm sm:text-base lg:text-lg">{metric.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-gray-100 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Deep dive into our most successful transformations and breakthrough results
            </p>
          </div>
              ...
              >
                <div className={`${index % 2 === 1 ? "lg:order-2" : ""}`}>
                  <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 lg:p-12 hover:shadow-2xl transition-all duration-300 border border-gray-200 group">
                    ...
                    <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 font-semibold">{study.client}</p>

                    <div className="space-y-6 sm:space-y-8">
                      <div>
                        <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Challenge</h4>
                        <p className="text-gray-600 leading-relaxed text-base sm:text-lg">{study.challenge}</p>
                      </div>

                      <div>
                        <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Solution</h4>
                        <p className="text-gray-600 leading-relaxed text-base sm:text-lg">{study.solution}</p>
                      </div>

                      <div>
                        <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Services Used</h4>
                ...
                <div className={`${index % 2 === 1 ? "lg:order-1" : ""}`}>
                  ...
                  <div className="bg-gradient-to-br from-gray-100 to-blue-100 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-dashed border-gray-300 mb-6 sm:mb-8 lg:mb-10">
                    <div className="aspect-video bg-white rounded-xl sm:rounded-2xl shadow-inner flex flex-col items-center justify-center text-gray-400 p-4">
                      ...
                      <p className="text-center text-sm sm:text-base lg:text-lg">{study.imageAlt}</p>
                    </div>
                  </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Hear directly from the businesses we've helped transform with our innovative solutions
            </p>
          </div>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-bold text-gray-800 text-base sm:text-lg truncate">{testimonial.author}</div>
                    <div className="text-gray-600 font-semibold text-sm sm:text-base truncate">{testimonial.role}</div>
                    <div className="text-blue-600 font-bold text-sm sm:text-base truncate">{testimonial.company}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto px-4">
              Proven expertise across diverse market sectors and business verticals
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-gray-900 via-slate-800 to-blue-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-12 sm:mb-16 leading-relaxed px-4">
            Join the hundreds of businesses that have transformed their e-commerce success with Urbantech Ecom's proven
            solutions
          </p>
