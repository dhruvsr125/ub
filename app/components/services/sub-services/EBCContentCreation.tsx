  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your product listings with stunning Enhanced Brand Content that tells your brand story and
              drives conversions through visual storytelling.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: TrendingUp, value: "165%", label: "Average Conversion Increase" },
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Professional EBC Design Services</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Complete Enhanced Brand Content creation from concept to implementation
            </p>
          </div>
                ...
                {[
                  {
                    icon: Palette,
                    title: "Custom Design",
                    description: "Unique, brand-aligned designs that stand out and reflect your brand personality.",
                  },
                  {
                    icon: ImageIcon,
                    title: "High-Quality Graphics",
                    description: "Professional graphics and imagery that showcase your products in the best light.",
                  },
                  {
                    icon: Lightbulb,
                  ...
                  },
                  {
                    ...
                    description: "Maintain consistent brand identity across all EBC modules and product listings.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Design content flow that guides customers from awareness to purchase decision.",
                  },
                  {
                    icon: Star,
                    title: "Feature Highlighting",
                    description: "Strategically showcase key product features and benefits that matter most to buyers.",
                  },
                  {
                    icon: Award,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Monitor EBC performance metrics and make data-driven optimization decisions.",
                  },
                  {
                    icon: Zap,
                    title: "Mobile Optimization",
                    description: "Ensure EBC content displays perfectly across all devices and screen sizes.",
                  },
                  {
                    icon: CheckCircle,
                    title: "Continuous Improvement",
                    description: "Regular updates and improvements based on performance data and market trends.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 border-0 text-white">
            <CardContent className="pt-8 pb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Listings?</h2>
              <p className="text-xl mb-8 text-blue-100">
                Create stunning EBC content that tells your brand story and converts visitors into customers
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
