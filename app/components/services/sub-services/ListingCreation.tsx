        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Create compelling Amazon listings that convert browsers into
              buyers. Professional listing creation that maximizes visibility
              and sales.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From research to launch, we handle every aspect of your Amazon
              listing creation
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Comprehensive market analysis to identify opportunities and competitive positioning.",
                  },
                  {
                    icon: Target,
                    title: "Keyword Research",
                    description:
                      "In-depth keyword research to maximize discoverability and search ranking potential.",
                  },
                  {
                    icon: Eye,
                  ...
                  },
                  {
                    ...
                    description:
                      "Create a comprehensive listing strategy tailored to your product and market.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Professional product photography and image optimization for maximum visual impact.",
                  },
                  {
                    icon: Award,
                    title: "Product Description",
                    description:
                      "Write detailed, engaging product descriptions that convert browsers into buyers.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
                ...
                {[
                  {
                    ...
                    description:
                      "Strategic product launch with optimized pricing and promotional campaigns.",
                  },
                  {
                    icon: TrendingUp,
                    title: "Performance Monitoring",
                    description:
                      "Continuous monitoring of listing performance with data-driven optimizations.",
                  },
                  {
                    icon: CheckCircle,
                    title: "Quality Assurance",
                    description:
                      "Thorough quality checks to ensure compliance with Amazon's guidelines and policies.",
                  },
                  {
                    icon: Target,
                    title: "Ongoing Optimization",
                    description:
                      "Regular updates and improvements based on performance data and market changes.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
          ...
          <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 border-0 text-white">
            <CardContent className="pt-8 pb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Ready to Create Your Perfect Listing?
              </h2>
              <p className="text-xl mb-8 text-blue-100">
                Let our experts create a high-converting Amazon listing that
