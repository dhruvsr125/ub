    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Streamline your product catalog with our comprehensive management
              services. From data organization to bulk operations, we ensure
              your catalog is optimized for success.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Complete Catalog Management Solutions
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From data entry to advanced automation, we handle every aspect of
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Design optimal catalog structure for your business",
                    features: [
                      "Navigation Design",
                      "Search Optimization",
            ...
            <TabsContent value="optimization" className="space-y-8">
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Optimize your catalog for better performance and user
                    experience
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="maintenance" className="space-y-8">
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Keep your catalog accurate, up-to-date, and performing
                    optimally
                  </CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our Catalog Management?
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                ...
                description:
                  "Handle catalogs of any size with our robust infrastructure",
              },
              {
                icon: Zap,
                title: "Lightning Fast",
                description:
                  "Process thousands of products in minutes, not hours",
              },
              {
                icon: Shield,
                title: "Data Security",
                description:
                  "Enterprise-grade security for your valuable product data",
              },
              {
                icon: Settings,
                title: "Custom Workflows",
                description:
                  "Tailored processes that fit your unique business needs",
              },
              {
                icon: BarChart3,
                title: "Analytics & Insights",
                description:
                  "Deep insights into catalog performance and optimization opportunities",
              },
              {
                icon: FileText,
                title: "Compliance Ready",
                description:
                  "Ensure your catalog meets all platform requirements and standards",
              },
            ].map((feature, index) => (
              <Card
                key={index}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Let our experts streamline your catalog management and boost your
